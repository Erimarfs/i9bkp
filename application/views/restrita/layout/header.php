...
<!-- blank.html  21 Nov 2019 03:54:41 GMT C:\wamp64\www\loja\application\public\assets\css\app.min.css-->
caralho
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
    <?php echo (isset($titulo) ? '<title>'.$titulo.'</title> Loja Virtual | ': '<title>Loja Virtual Vende Tudo</title>') ?>
    <!-- General CSS Files -->
